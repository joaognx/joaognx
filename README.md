# Olá, eu sou João Gabriel Nunes 👋

🎓 Estudante de Ciência da Computação na Universidade Federal do Piauí (UFPI)

💡 Apaixonado por desenvolvimento de software, robótica, Internet das Coisas (IoT) e inovação tecnológica.

🚀 Atualmente atuo como Vice-Presidente da Liga Acadêmica de Robótica Aplicada (LARA) e participo de projetos de pesquisa, extensão e desenvolvimento de software.

🌱 Aprimorando conhecimentos em Desenvolvimento Mobile com Swift/SwiftUI, Computação em Nuvem, Inteligência Artificial, Sistemas Embarcados e Arquitetura de Software.
...
![Assembly RISC-V](https://img.shields.io/badge/-RISC--V-333333?style=flat)
...
![Sensores](https://img.shields.io/badge/-Sensores-333333?style=flat)
...
[![GitHub](https://img.shields.io/badge/-joaognx-181717?style=flat-square\&logo=github\&logoColor=white)](https://github.com/joaognx)
